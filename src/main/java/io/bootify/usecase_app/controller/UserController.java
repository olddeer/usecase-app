...
import io.bootify.usecase_app.service.UserService;
...
public class UserController {
    ...
    public void prepareContext(final Model model) {
        model.addAttribute("rolesValues", roleRepository.findAll(Sort.by("roleId"))
                .stream()
                .collect(CustomCollectors.toSortedMap(Role::getRoleId, Role::getRoleId)));
    }
